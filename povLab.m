    ...
    methods (Access = public)
        ...
        function tex = texture(o, varargin)
            ...
            if (~ismember('pigment', p.UsingDefaults))
                tex = sprintf(['texture { pigment{ rgb <%0.2f, %0.2f, %0.2f>}\n'...
                               '          finish { %s }}\n'], ...
                               pigment(1), pigment(2), pigment(3),...
                               finish);
            else
                tex = sprintf(['texture { pigment{ checker rgb <%0.2f, %0.2f, %0.2f> rgb <%0.2f, %0.2f, %0.2f>  }\n'...
                               '          finish { %s }}\n'], ...
        ...
        function box(o, varargin)
            ...
            fprintf(o.fh, ['box {<%0.2f, %0.2f, %0.2f>, <%0.2f, %0.2f, %0.2f>\n'...
                           ...
                           texture, o.trans(scale, rotate, translate));
        end
        ...
        function wire_box(o, varargin)
            ...
            % Write
            fprintf(o.fh, ['object{ Wire_Box (<%0.2f, %0.2f, %0.2f> <%0.2f, %0.2f, %0.2f>, %0.2f, %0.2f)\n'...
                           '        texture { %s }\n' ...
                           '       %s}\n\n'],...
                           llf_corner(1), llf_corner(2), llf_corner(3), ...
                           urb_corner(1), urb_corner(2), urb_corner(3), ...
