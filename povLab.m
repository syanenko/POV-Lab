...
%
    ...
    methods (Access = public)
        ...
        function scene_begin(o, varargin)
            ...
            % Write header
            fprintf(o.fh, ['// Generated by POV-Lab (https://www.mathworks.com/matlabcentral/fileexchange/123520-pov-lab-matlab-interface-to-pov-ray) \n' ...
                           '// POB-Lab version: %s\n'...
                           '// Matlab version:  %s\n' ...
                           '// POV-Ray version: %s\n\n' ...
                           '#version %s;\n'], o.version, version(), o.pov_version, o.pov_version);
