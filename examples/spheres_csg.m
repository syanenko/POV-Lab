...
pov.difference_begin();
    ...
    pov.union_begin();
          pov.sphere('position', [3 1 2], 'radius', 0.6, 'texture', tex_red,   'transform', [1 1 1; 0 0 0; 0 0 0]);
          pov.sphere('position', [2 3 1], 'radius', 0.8, 'texture', tex_blue,  'transform', [1 1 1; 0 0 0; 0 0 0]);
          pov.sphere('position', [1 2 3], 'radius', 1.0, 'texture', tex_green, 'transform', [1 1 1; 0 0 0; 0 0 0]);
     pov.union_end();
pov.difference_end();
