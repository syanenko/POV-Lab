...
pl.scene_begin('scene_file', 'primitives.pov', 'image_file', 'primitives.png');
    ...
    tex_cone       = pl.declare("tex_cone",       pl.texture('pigment', [0 0 1]));
    tex_cone_trunc = pl.declare("tex_cone_trunc", pl.texture('pigment', [8 2 3]));
    ...
    pl.cone('base_point', [0 12 0], 'base_radius', 1.5, 'cap_point', [0 12 5], 'texture', tex_cone_trunc);    
    pl.cone('base_point', [0 16 0], 'base_radius', 1.5, 'cap_point', [0 16 5], 'cap_radius', 0.5, 'texture', tex_cone);
