...
pl.scene_begin('scene_file', 'primitives.pov', 'image_file', 'primitives.png');
    ...
    tex_flat = pl.declare("tex_flat", pl.texture('pigment', [1.5 1.5 1.5]));
    pl.plane('normal', [1,0,0], 'distance', -10, 'texture', tex_flat, 'translate', [0 0 1]);
    ...
    % Textures
    tex_sphere     = pl.declare("tex_sphere",     pl.texture('pigment', [2 0.1 0]));
    tex_cylinder   = pl.declare("tex_cylinder",   pl.texture('pigment', [0 2 0]));
    tex_cone       = pl.declare("tex_cone",       pl.texture('pigment', [0 0.5 4]));
    tex_cone_trunc = pl.declare("tex_cone_trunc", pl.texture('pigment', [0 2 4]));
    ...
    pl.cone('base_point', [0 12 0], 'base_radius', 1.5, 'cap_point', [0 12 6.5], 'texture', tex_cone);    
