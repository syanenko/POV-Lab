...
pov.camera('angle', 35, 'location', [23 6 11], 'look_at', [0 4 0], 'type', 'perspective');
...
pov.lathe('points', [0.00 0.00; 0.22 0.00; 0.62 0.54; 0.21 0.83; 0.19 1.46; 0.29 1.50; 0.26 1.53],...
        'spline_type', 'quadratic_spline',...
        'sturm', true,...
        'texture', 'Ruby_Glass',...
        'scale', [4 4 4], 'rotate', [ 90 0 0], 'translate', [4 4 0]);

pov.lathe('points', [0.00 0.00; 0.42 0.00; 0.62 0.54; 0.21 0.83; 0.19 1.46; 0.29 1.50; 0.26 1.53],...
        'spline_type', 'quadratic_spline',...
        'sturm', true,...
