...
pl.scene_begin('scene_file', 'prism.pov', 'image_file', 'prism.png');
    pl.include("glass");
    ...
    % Objects
    pl.prism('p1', [0,0,0], 'p2', [3  2 4], 'tex_odd', tex_pink,   'tex_even', tex_gray, 'radius', 0.04);
    pl.prism('p1', [0,0,0], 'p2', [-3 2 2], 'tex_odd', tex_blue,   'tex_even', tex_gray, 'radius', 0.04);
    pl.prism('p1', [3 2 4], 'p2', [-3 2 2], 'tex_odd', tex_yellow, 'tex_even', tex_gray, 'radius', 0.04);
