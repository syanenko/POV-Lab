...
pl.scene_begin('scene_file', 'surface1.pov', 'image_file', 'surface1.png');
    ...
    pl.surface('surface', s, 'colormap', 'turbo', 'scale', [1, 1, 0.35], 'texture_odd', 'Gold_Nugget', 'texture_even', 'T_Ruby_Glass');
...
pl.scene_begin('scene_file', 'surface2.pov', 'image_file', 'surface2.png');
    ...
    % With checkerd texture
    % pl.surface('surface', s, 'colormap', 'turbo', 'scale', [1, 1, 0.35], 'texture_odd', 'Bright_Bronze', 'texture_even', 'Orange_Glass');
